...
{
    public abstract class ELAPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ELAPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ELAPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ELAPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ELAPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ELAPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ELAPDbContext, Task<T>> func)
        {
            T result;
